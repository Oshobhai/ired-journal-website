...
export function Header(){
  return <>
    ...
    <header className="siteHeader"><div className="container brandRow">
      ...
      <div className="headerActions"><div className="search"><input aria-label="Search" placeholder="Search papers, books, authors, keywords..."/><button aria-label="Search">⌕</button></div><Link className="btn btnGold compact" href="/contact">↥ Contact to Submit</Link><Link className="btn btnOutline compact" href="/admin">♟ Admin Login</Link></div>
    </div></header>
    <nav className="mainNav"><div className="container navInner"><Link className="active" href="/">Home</Link><Link href="/about">About IRED</Link><Link href="/green">GREEN Papers⌄</Link><Link href="/red">RED Books⌄</Link><Link href="/editorial-board">Editorial Board</Link><Link href="/author-guidelines">Author Guidelines</Link><Link href="/publication-ethics">Publication Ethics</Link><Link href="/archives">Archives</Link><Link href="/contact">Contact Us</Link><span className="navTagline">“Knowledge for a Better Tomorrow”</span></div></nav>
  </>
}
