...
export function Header(){
  return <>
    ...
    <header className="siteHeader"><div className="container brandRow">
      ...
      <div className="headerActions"><form className="search" action="/search" method="get"><input name="q" aria-label="Search publications" placeholder="Search papers, books, authors, keywords..."/><button type="submit" aria-label="Search">⌕</button></form><Link className="btn btnGold compact" href="/contact">Contact to Submit</Link></div>
    </div></header>
    ...
    <details className="mobileNav"><summary>Explore IRED</summary><div className="mobileNavPanel"><div className="mobileNavLinks"><Link href="/">Home</Link><Link href="/about">About IRED</Link><Link href="/green">GREEN Papers</Link><Link href="/red">RED Books</Link><Link href="/editorial-board">Editorial Board</Link><Link href="/author-guidelines">Author Guidelines</Link><Link href="/publication-ethics">Publication Ethics</Link><Link href="/archives">Archives</Link><Link href="/contact">Contact Us</Link></div><form className="mobileSearch" action="/search" method="get"><input name="q" aria-label="Search publications" placeholder="Search publications..."/><button type="submit" aria-label="Search">⌕</button></form><div className="mobileEditorial"><span>Staff access</span><Link href="/admin">Editorial Login</Link></div></div></details>
  </>
}
...
export function Footer(){
  return <footer className="footer"><div className="container"><div className="footerGrid">
    ...
    <div><h3>Contact Us</h3><p>A-3, 3rd Floor, Gita Apartment,<br/>Nr. Hirabaug Crossing, Ambawadi,<br/>Ahmedabad-380015</p><p>☎ 7383000930 · 7203998343</p><p>✉ ired.foundation@gmail.com</p></div>
