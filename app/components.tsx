...
export function Footer(){
  return <footer className="footer"><div className="container"><div className="footerGrid">
    <div className="footerBrand"><img src="/ired-header-logo.webp?v=5" alt="IRED"/><p><strong>Institute of Research Education and Development (IRED)</strong></p><p>Publishing Body & Publisher</p><p>A-3, 3rd Floor, Gita Apartment,<br/>Nr. Hirabaug Crossing, Ambawadi,<br/>Ahmedabad-380015, Gujarat, India.</p></div>
