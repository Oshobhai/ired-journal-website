...
export function Header(){
  return <>
    ...
    <header className="siteHeader"><div className="container brandRow">
      <Link href="/" className="brandLogoLink" aria-label="IRED home"><img className="iredLogo" src="/api/brand/ired_header" alt="IRed — Institute of Research Education and Development"/></Link>
...
export function Footer(){
  return <footer className="footer"><div className="container"><div className="footerGrid">
    <div className="footerBrand"><img src="/api/brand/ired_footer" alt="IRed — Institute of Research Education and Development"/><p><strong>Institute of Research Education and Development (IRED)</strong></p><p>Publishing Body & Publisher</p><p>A-3, 3rd Floor, Gita Apartment,<br/>Nr. Hirabaug Crossing, Ambawadi,<br/>Ahmedabad-380015, Gujarat, India.</p></div>
