...
export default function Home(){
  return <><Header/><main>
    ...
    <section className="publicationStrip" id="publications"><div className="container journalGrid">
      <article className="journalCard green"><img className="journalLogo" src="/green-logo.svg" alt="GREEN: The Research Journal"/><div className="journalCopy"><h2>Research Papers</h2><p>Publish and access individual research papers, articles and scholarly contributions across a wide range of disciplines.</p><Link className="btn btnGreen" href="/green">View All Papers →</Link><div className="featureRow"><span>⚖ Peer-reviewed</span><span>▣ Open access</span><span>◉ Multidisciplinary</span></div></div><div className="journalWatermark">▤</div></article>
      <article className="journalCard red"><img className="journalLogo" src="/red-logo.svg" alt="RED: The Research Journal"/><div className="journalCopy"><h2>Research Books</h2><p>Access complete research books, compiled volumes and published editions featuring selected research themes.</p><Link className="btn btnRed" href="/red">View All Books →</Link><div className="featureRow"><span>▣ Compiled volumes</span><span>▤ Scholarly publication</span><span>▰ Easy access</span></div></div><div className="journalWatermark">▥</div></article>
    </div></section>
