  ...
  return <>
    ...
    <main className="container" style={{padding:'22px 0 36px'}}>
      ...
      <section className="contentCard" style={{borderTop:'4px solid #cb2528'}}>
        <img className="redJournalLogo" src="/red-logo-original.webp?v=1" alt="RED: The Research Journal e-Journal — Online Scholarly Publication" style={{width:240,maxWidth:'100%',height:'auto',objectFit:'contain'}}/>
