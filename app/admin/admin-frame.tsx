  ...
  return <div className={styles.portal}>
    ...
    <div className={styles.body}>
      <aside className={styles.side}>
        ...
        {isAdmin?<><div className={styles.sideTitle}>Publication Workflow</div><nav className={styles.navGroup}><NavItem href="/admin/green-generator" label="GREEN Word Formatter" code="WF" active={active==='green-generator'}/><NavItem href="/admin/upload" label="Upload Center" code="UP" active={active==='upload'}/></nav><div className={styles.sideTitle}>Administration</div><nav className={styles.navGroup}><NavItem href="/admin/access" label="Staff Access" code="AC" active={active==='access'}/><NavItem href="/admin/security" label="Security & Storage" code="SC" active={active==='security'}/></nav></>:null}
